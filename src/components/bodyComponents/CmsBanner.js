...
const CmsBanner = () => {
  return (
    <div className="offer-section 2xl:px-28 xl:px-28 lg:px-20 md:px-16 sm:px-14 px-8 py-12 flex items-center">
      <Fade left>
      ...
      <Fade right>
        <div className="max-w-md text-right ml-auto ">
          ...
          <div className="stroke-text-offer font-['Poppins'] 2xl:text-7xl xl:text-7xl lg:text-5xl md:text-4xl sm:text-3xl text-2xl mt-6">
            2020
          </div>
          <div className="stroke-text-offer font-['Poppins'] 2xl:text-7xl xl:text-7xl lg:text-5xl md:text-4xl sm:text-3xl text-2xl">
            30% OFF
          </div>
        </div>
      </Fade>
